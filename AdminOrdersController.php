<?php
/*
*  @author Mahefa A. <abelmahefa@gmail.com>
*  @copyright  2017 Mahefa A.
*  @license    MIT Open Source (https://opensource.org/licenses/MIT)
*/


class AdminOrdersController extends AdminOrdersControllerCore //AdminController
{
                ...
                if (!Validate::isLoadedObject($order_carrier)) {
                    ...
                    if ($order_carrier->update()) {
						...
						if($order->current_state != $shipped_status && $order->current_state != Configuration::get('PS_OS_CANCELED'))
						{
							...
							// Au cas où on fait une gestion des stocks avancer
